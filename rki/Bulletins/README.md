...
- Generierte Periodenarchive: Wochen unter `Monate/<Montag-YYYY>/<Montag-MM>/ZIP/Wochen/`, Monate unter `Monate/YYYY/MM/ZIP/` mit `Markdown/index.md`, Jahre unter `Jahre/YYYY/ZIP/`; Periodenmanifeste unter `Manifeste/Archive/<week|month|year>/`.
